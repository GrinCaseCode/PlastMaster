...
if ( $(this).scrollTop() > 0 && $menu.hasClass("default") ){
	...
	$(".item-tab__head").click(function() {
		$(this).parent().toggleClass("active");
		$(this).siblings().slideToggle(200);
		$(this).parent().siblings(".item-tab").removeClass("active");
		$(this).parent().siblings(".item-tab").find(".item-tab__content").slideUp(200);
	});
